...
import com.yangyang.mobile.test.myplugin4.config.TransConstant;
...
public class TestAopAsmTransform extends Transform {

    private static final String TAG = "TestAopAsmTransform  ---> ";


    @Override
    public String getName() {
        return "TestAopAsmTransform";
    }
    ...
    private void doAsm(File file) throws Exception {
        ...
        try {
            ...
            ClassVisitor visitor = new TestAopAsmClassVisitor(writer);
